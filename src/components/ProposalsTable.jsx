...
const ProposalsTable = ({ proposals, programId }) => {
  const navigate = useNavigate();
  const filteredProposals = proposals.filter(p => String(p.programId) === String(programId));
              ...
              <td className="px-6 py-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-0.5">ID: #{proposal.id.slice(-4)}</div>
                  </div>
                </div>
              </td>
              <td className="px-6 py-5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-slate-600">{proposal.leader}</span>
                </div>
              </td>
              <td className="px-6 py-5">
